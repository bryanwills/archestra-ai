...
import { enqueuePermissionSyncForIngestedContent } from "./permission-sync-trigger";
    ...
    try {
      ...
      if (batchCount === 0) {
        ...
        if (
          ...
          // Content-ingest trigger (all batches drained synchronously here
          // rather than in the batch-embedding handler).
